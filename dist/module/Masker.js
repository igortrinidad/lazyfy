...
exports.Masker = exports.unmask = exports.mask = exports.extractCountryCodeAndPhone = exports.getValidDigitCounts = exports.predictCountryFromPhone = exports.isValidPhoneNumber = exports.getSupportedCountries = exports.getCountryCode = exports.formatPhoneWithCountryCode = void 0;
...
const formatPhoneWithCountryCode = (phoneNumber, country, throwsErrorOnValidation = false) => {
    if (!phoneNumber) {
        ...
        return (0, masker_1.masker)(phoneNumber, enums_1.DEFAULT_PHONE_MASK_WITH_DDI, true);
    }
    ...
    if (Array.isArray(config.digitCount)) {
        ...
        const maskedNumber = (0, masker_1.masker)(cleanNumber, selectedMask, true);
...
const isValidPhoneNumber = (phoneNumber, country) => {
    try {
        (0, exports.formatPhoneWithCountryCode)(phoneNumber, country, true);
        return true;
    }
    catch (_a) {
        return false;
...
exports.Masker = {
    ...
    formatPhoneWithCountryCode: exports.formatPhoneWithCountryCode,
    getCountryCode: exports.getCountryCode,
    getSupportedCountries: exports.getSupportedCountries,
    isValidPhoneNumber: exports.isValidPhoneNumber,
    getValidDigitCounts: exports.getValidDigitCounts,
    predictCountryFromPhone: exports.predictCountryFromPhone,
    extractCountryCodeAndPhone: exports.extractCountryCodeAndPhone
};
