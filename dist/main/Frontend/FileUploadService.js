...
class FileUploadService {
    ...
    get formatted_name() {
        return (0, file_helpers_1.formatFileName)(this.name) ?? '';
    }
    get formatted_size() {
        return (0, file_helpers_1.formatFileSize)(this.size) ?? '0kb';
    }
    async wait(ms) {
    ...
    async convertImageToWebp(image) {
        return new Promise((resolve, reject) => {
            try {
                const img = new Image();
                img.src = image;
